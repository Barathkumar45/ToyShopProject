    ...
    <div className="App">
      <div className="login-container">
        ...
        <div className="login-links">
          ...
          <button ><Link to="/admin" className="but">Admin Login</Link></button>
          {/* Link to User Login Page */}
          <button ><Link to="/user" className="but">User Login</Link></button>
        </div>
        <p className="parag">New to ToyFinity? <Link to="/Signup" className="link2">Create Account</Link></p>
      </div>
    </div>
  );
}
